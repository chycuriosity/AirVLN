...
class Param:
    def __init__(self):
        ...
        self.parser.add_argument('--intersection_depth_gate_mode', type=str, default="cheap_strict", help="off/strict/cheap_strict/all local depth gating before cloud checks")
        self.parser.add_argument('--intersection_min_open_branches', type=int, default=2)
        self.parser.add_argument('--intersection_depth_open_threshold', type=float, default=0.18)
        ...
        self.parser.add_argument('--intersection_detector', type=str, default="cloud", help="cloud/reference_proxy detector for intersection experiments")
        ...
        self.parser.add_argument('--cloud_max_tokens', type=int, default=128)
        ...
        self.parser.add_argument('--cloud_depth_grid_size', type=int, default=3)
        self.parser.add_argument('--cloud_depth_near_threshold', type=float, default=0.05)
